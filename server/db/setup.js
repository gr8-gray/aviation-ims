...
async function setup() {
  ...
  try {
    ...
    // Requisitions
    const reqRows = [
      [dn(1,18),'A0A','2840018374920','166490','VMM365-2024-0892','01','FB','backordered',1,18],
      [dn(2,12),'A0A','4730014482680','168019','VMM365-2024-0910','02','FB','due_in',2,12],
      [dn(3,8), 'A0A','2915011234567','168661','VMM365-2024-0931','03','FB','submitted',2,8],
      [dn(4,5), 'A0A','5330005892341',null,null,'03','FC','submitted',10,5],
      [dn(5,22),'AP1','5945002938471','169017','VMM365-2024-0841','01','FB','backordered',1,22],
      [dn(6,31),'A0A','5975013847291','168019','VMM365-2024-0801','02','FB','shipped',1,31],
    ...
    // Transactions
    const txRows = [
      ['issue','2915011234567','168661','VMM365-2024-0931',1,8],
      ['issue','4730014482680','168019','VMM365-2024-0910',1,12],
      ['issue','9150014728391','166490','VMM365-2024-0820',2,30],
      ['issue','5365001849302','168661','VMM365-2024-0931',4,8],
      ['issue','5340001023847','169017','VMM365-2024-0841',6,20],
      ['issue','2915011234567','169354','VMM365-2024-0788',1,45],
      ['issue','9150014728391','168661','VMM365-2024-0756',4,60],
      ['receipt','9150014728391',null,null,4,43],
      ['receipt','5365001849302',null,null,50,90],
      ['issue','5975013847291','168019','VMM365-2024-0801',1,31],
      ['issue','4730014482680','166490','VMM365-2024-0820',2,32],
    ];
